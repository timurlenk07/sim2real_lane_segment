...
class RightLaneSTModule(pl.LightningModule):
    ...
    def train_dataloader(self):
        ...
        return DataLoader(STSet, sampler=sampler, batch_size=self.batch_size, num_workers=8)
...
def main(args, model_name: str, reproducible: bool, comet: bool):
    ...
    # Reload best model
    model = RightLaneSTModule.load_from_checkpoint(model_checkpoint.kth_best_model_path, dataPath=args.dataPath)
